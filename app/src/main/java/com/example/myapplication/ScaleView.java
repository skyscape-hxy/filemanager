...
public class ScaleView extends androidx.appcompat.widget.AppCompatImageView implements
...
//    }
    ...
    public void bigger(){
        postDelayed(new ScaleRunnale(centerX, centerY, 2), 16);
    }
    public void smaller(){
        postDelayed(new ScaleRunnale(centerX, centerY, 1), 16);
    }
